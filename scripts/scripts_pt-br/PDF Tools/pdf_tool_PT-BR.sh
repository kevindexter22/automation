...
# ─────────────────────────────────────────────────────────────────────────────
  melhorar_pdf_qualidade() {
    local ARQUIVO_PDF="$1"
    local SAIDA_DIR="/home/$USER/Documentos/PDF/Otimizados"
    ...
    gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/ebook -dNOPAUSE -dQUIET -dBATCH -sOutputFile=$SAIDA_DIR/pdf_otimizado.pdf "$ARQUIVO_PDF"
...
# ─────────────────────────────────────────────────────────────────────────────
# Função das tarefas a serem executadas
# ─────────────────────────────────────────────────────────────────────────────
  ...
  como_usar() {
       ...
       echo
       echo '1- Os arquivos em PDF a serem otimizados precisam estar no diretório /home/'$USER'/Documentos/PDF'
       echo '2- Os arquivos otimizados ficarão em /home/'$USER'/Documentos/PDF/Otimizados'
       echo '3- Caso o diretório não exista você pode cria-lo utilizando o comando mkdir /home/'$USER'/Documentos/PDF && mkdir /home/'$USER'/Documentos/PDF/Otimizados'
       echo
  }
